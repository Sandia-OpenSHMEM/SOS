...
SHMEM_INTERNAL_ENV_DEF(OFI_STX_AUTO_PARTITION, bool, false, SHMEM_INTERNAL_ENV_CAT_TRANSPORT,
                       "Automatically partition the STX pool evenly across PEs on each host")
