...
SHMEM_INTERNAL_ENV_DEF(TEAMS_MAX, long, 10, SHMEM_INTERNAL_ENV_CAT_OTHER,
                       "Maximum number of teams per PE")
SHMEM_INTERNAL_ENV_DEF(DISABLE_TEAM_SHARED, bool, false, SHMEM_INTERNAL_ENV_CAT_OTHER,
                       "Disable SHMEM_TEAM_SHARED")
