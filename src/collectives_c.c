...
SHMEM_EVAL_MACRO_FOR_INTS_WITH_ITYPE_OP(SHMEM_DEF_TO_ALL,and,SHM_INTERNAL_BAND,)
SHMEM_EVAL_MACRO_FOR_INTS_WITH_ITYPE_OP(SHMEM_DEF_TO_ALL,or,SHM_INTERNAL_BOR,)
SHMEM_EVAL_MACRO_FOR_INTS_WITH_ITYPE_OP(SHMEM_DEF_TO_ALL,xor,SHM_INTERNAL_BXOR,)

SHMEM_EVAL_MACRO_FOR_INTS_WITH_ITYPE_OP(SHMEM_DEF_TO_ALL,min,SHM_INTERNAL_MIN,)
SHMEM_EVAL_MACRO_FOR_FLOATS_WITH_ITYPE_OP(SHMEM_DEF_TO_ALL,min,SHM_INTERNAL_MIN,)
SHMEM_EVAL_MACRO_FOR_INTS_WITH_ITYPE_OP(SHMEM_DEF_TO_ALL,max,SHM_INTERNAL_MAX,)
SHMEM_EVAL_MACRO_FOR_FLOATS_WITH_ITYPE_OP(SHMEM_DEF_TO_ALL,max,SHM_INTERNAL_MAX,)

SHMEM_EVAL_MACRO_FOR_INTS_WITH_ITYPE_OP(SHMEM_DEF_TO_ALL,sum,SHM_INTERNAL_SUM,)
SHMEM_EVAL_MACRO_FOR_FLOATS_WITH_ITYPE_OP(SHMEM_DEF_TO_ALL,sum,SHM_INTERNAL_SUM,)
SHMEM_EVAL_MACRO_FOR_CMPLX_WITH_ITYPE_OP(SHMEM_DEF_TO_ALL,sum,SHM_INTERNAL_SUM,)
SHMEM_EVAL_MACRO_FOR_INTS_WITH_ITYPE_OP(SHMEM_DEF_TO_ALL,prod,SHM_INTERNAL_PROD,)
SHMEM_EVAL_MACRO_FOR_FLOATS_WITH_ITYPE_OP(SHMEM_DEF_TO_ALL,prod,SHM_INTERNAL_PROD,)
SHMEM_EVAL_MACRO_FOR_CMPLX_WITH_ITYPE_OP(SHMEM_DEF_TO_ALL,prod,SHM_INTERNAL_PROD,)
