...
void __shmem_function_attributes__ FC_SHMEM_CLEAR_LOCK(long *lockp);
void
...
void __shmem_function_attributes__ FC_SHMEM_SET_LOCK(long *lockp);
void
...
fortran_integer_t __shmem_function_attributes__ FC_SHMEM_TEST_LOCK(long *lockp);
fortran_integer_t
