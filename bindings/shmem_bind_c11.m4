...
dnl selection interfaces and C++ function overloading interfaces.
dnl
...
dnl
dnl C++ has the same type similarity restrictions as C11 generic selection.
dnl
define(`SHMEM_CXX_DEFINE_FOR_RMA', `SHMEM_BIND_C11_RMA(`$1')')dnl
define(`SHMEM_CXX_DEFINE_FOR_AMO', `SHMEM_BIND_C11_AMO(`$1')')dnl
define(`SHMEM_CXX_DEFINE_FOR_EXTENDED_AMO', `SHMEM_BIND_C11_EXTENDED_AMO(`$1')')dnl
define(`SHMEM_CXX_DEFINE_FOR_BITWISE_AMO', `SHMEM_BIND_C11_BITWISE_AMO(`$1')')dnl
