...
$1(int8,      int8_t,             `SHM_INTERNAL_INT8',       `$2', `$3')
$1(int16,     int16_t,            `SHM_INTERNAL_INT16',      `$2', `$3')
$1(int32,     int32_t,            `SHM_INTERNAL_INT32',      `$2', `$3')
$1(int64,     int64_t,            `SHM_INTERNAL_INT64',      `$2', `$3')
$1(uint8,     uint8_t,            `SHM_INTERNAL_INT8',       `$2', `$3')
$1(uint16,    uint16_t,           `SHM_INTERNAL_INT16',      `$2', `$3')
$1(uint32,    uint32_t,           `SHM_INTERNAL_INT32',      `$2', `$3')
$1(uint64,    uint64_t,           `SHM_INTERNAL_INT64',      `$2', `$3')
$1(size,      size_t,             `SHM_INTERNAL_SIZE_T',     `$2', `$3')')dnl
dnl
define(`SHMEM_BIND_C_COLL_MIN_MAX', dnl args: macro_name, op_name, op_const
`$1(char,      char,               `SHM_INTERNAL_CHAR',        `$2', `$3')
$1(schar,      signed char,        `SHM_INTERNAL_SCHAR',       `$2', `$3')
$1(short,      short,              `SHM_INTERNAL_SHORT',       `$2', `$3')
$1(int,        int,                `SHM_INTERNAL_INT',         `$2', `$3')
$1(long,       long,               `SHM_INTERNAL_LONG',        `$2', `$3')
$1(longlong,   long long,          `SHM_INTERNAL_LONG_LONG',   `$2', `$3')
$1(ptrdiff,    ptrdiff_t,          `SHM_INTERNAL_PTRDIFF_T',   `$2', `$3')
$1(uchar,      unsigned char,      `SHM_INTERNAL_UCHAR',       `$2', `$3')
$1(ushort,     unsigned short,     `SHM_INTERNAL_USHORT',      `$2', `$3')
$1(uint,       unsigned int,       `SHM_INTERNAL_UINT',        `$2', `$3')
$1(ulong,      unsigned long,      `SHM_INTERNAL_ULONG',       `$2', `$3')
...
$1(uint32,     uint32_t,           `SHM_INTERNAL_INT32',       `$2', `$3')
$1(uint64,     uint64_t,           `SHM_INTERNAL_INT64',       `$2', `$3')
$1(size,       size_t,             `SHM_INTERNAL_SIZE_T',      `$2', `$3')
