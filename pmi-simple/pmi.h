...
@*/
int PMI_FUNCTION_ATTRIBUTES PMI_KVS_Get( const char kvsname[], const char key[], char value[], int length);
...
@*/
int PMI_FUNCTION_ATTRIBUTES PMI_Spawn_multiple(int count,
                                               const char * cmds[],
                                               const char ** argvs[],
                                               const int maxprocs[],
